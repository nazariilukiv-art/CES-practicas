...
class MainActivity : AppCompatActivity() , View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // AÑADIDO: acción para el botón "R" (solo existe en modo horizontal)
        val botonReset = binding.root.findViewById<View?>(R.id.botonReset)
    ...
    override fun onClick(v: View?) {
        //diferenciar quein ha lanzado el evento
        when(v!!.id){
